...
class Game(arcade.Window):
    ...
    def on_draw(self):
        ...
        if self.gameOver:
            if self.night:
                arcade.draw_text('Game Over', self.w//2-200, self.h//2, arcade.color.WHITE, DEFAULT_FONT_SIZE, width=400, font_name='Kenney Mini Square', align='center')
            else:
                arcade.draw_text('Game Over', self.w//2-200, self.h//2, arcade.color.BLACK, DEFAULT_FONT_SIZE, width=400, font_name='Kenney Mini Square', align='center')
        else:
            arcade.start_render()
